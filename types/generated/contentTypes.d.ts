...
export interface ApiCatalogItemCatalogItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Best_choise: Schema.Attribute.Boolean;
    Bestseller: Schema.Attribute.Boolean;
    catalog_sections: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiCatalogRootSectionCatalogRootSection
  extends Struct.CollectionTypeSchema {
...
export interface ApiCatalogSectionCatalogSection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    catalog_items: Schema.Attribute.Relation<
      ...
      'api::catalog-item.catalog-item'
    >;
    catalog_root_section: Schema.Attribute.Relation<
      'manyToOne',
      'api::catalog-root-section.catalog-root-section'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    secondName: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
